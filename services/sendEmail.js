...
const sendEmail = async (email, templateName, data) => {
    ...
    // const htmlTemplate = fs.readFileSync(`./email-templete/signUp.html`, 'utf-8');
    const htmlTemplate = fs.readFileSync(`./email-templete/${templateName}.html`, 'utf-8');
    const forgetTemplate = fs.readFileSync(`./email-templete/${templateName}.html`, 'utf-8');
    const verificationTemplate = fs.readFileSync(`./email-templete/${templateName}.html`, 'utf-8');
    ...
    } else if (templateName === "verifyPassword") {
